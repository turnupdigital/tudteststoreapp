...
@EnableZuulProxy
public class TudteststoreappApp {

    private static final Logger log = LoggerFactory.getLogger(TudteststoreappApp.class);

    private final Environment env;

    public TudteststoreappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes tudteststoreapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TudteststoreappApp.class);
